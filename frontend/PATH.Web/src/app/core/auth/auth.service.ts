...
import { RegisterUserModel } from '../../features/auth/models/RegisterUserModel';
import { LoginResponse } from '../../features/auth/models/LoginResponse';
import { catchError, of, tap } from 'rxjs';
import { AccessModel } from '../../features/auth/models/AccessModel';
...
export class AuthService {
  ...
  userCurrentOrgRole = signal<string | null>(null);
